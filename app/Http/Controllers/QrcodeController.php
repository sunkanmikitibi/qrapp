...
class QrcodeController extends AppBaseController
{
    ...
    public function store(CreateQrcodeRequest $request)
    {
        ...
        //generate qrcode
        //save the qr image in a folder on the server

        $file = 'qrcodesimg/'.time().'.png';

       $newQrcode =  QRCode::text("This is our message")
        ->setSize(4)
        ->setMargin(2)
        ->setOutfile($file)
        ->png();
        ...
        if($newQrcode) {
            ...
            Flash::error('There is a problem check your data again.');
        }
